    ...
    <View style={styles.outer} accessible={false}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View
          ...
          accessibilityLabel="Customise output"
        >
          <Text style={styles.title} accessible={false} importantForAccessibility="no">Customise output</Text>
        </View>
        ...
        {!canContinue ? (
          <View
            ...
            accessibilityLabel="This screen needs backendBaseUrl, jobId, and doc passed from the upload step."
          >
            <Text style={styles.error} accessible={false} importantForAccessibility="no">
        ...
        >
          <Text style={styles.cardTitle} accessible={false} importantForAccessibility="no">Speech speed</Text>
          <Text style={styles.valueText} accessible={false} importantForAccessibility="no">{speechRate.toFixed(1)}x</Text>
        </View>
        <View style={styles.row} accessible={false}>
          <Pressable
            ...
            hitSlop={10}
          >
            <Text style={styles.btnText} accessible={false} importantForAccessibility="no">Slower</Text>
          </Pressable>
          ...
          <Pressable
            ...
            hitSlop={10}
          >
            <Text style={styles.btnText} accessible={false} importantForAccessibility="no">Faster</Text>
          </Pressable>
        </View>
        ...
        >
          <Text style={styles.cardTitle} accessible={false} importantForAccessibility="no">Bars grouped together</Text>
          <Text style={styles.valueText} accessible={false} importantForAccessibility="no">{barsPerGroup}</Text>
        </View>
        <View style={styles.row} accessible={false}>
          <Pressable
            style={styles.btn}
            ...
            hitSlop={10}
          >
            <Text style={styles.btnText} accessible={false} importantForAccessibility="no">-</Text>
          </Pressable>
        ...
        <View
          style={styles.card}
          accessible={true}
          accessibilityLabel={`NATO note spelling. When enabled, notes will be spoken using NATO equivalents, for example A is Alpha, B is Bravo. Currently ${useNato ? "on" : "off"}.`}
        >
          <Text style={styles.cardTitle} accessible={false} importantForAccessibility="no">NATO note spelling</Text>
          <Text style={styles.subText} accessible={false} importantForAccessibility="no">
        ...
        <Pressable
          ...
          hitSlop={10}
        >
          <Text style={[styles.btnText, useNato ? styles.btnTextOn : null]} accessible={false} importantForAccessibility="no">
            {useNato ? "On" : "Off"}
          </Text>
        </Pressable>
        ...
        <View
          style={styles.card}
          accessible={true}
          accessibilityLabel={`Notes only. When enabled, reading a bar says only the note names, for example A, C sharp, D, with no beat numbers or rhythm labels. Currently ${notesOnly ? "on" : "off"}.`}
        >
          <Text style={styles.cardTitle} accessible={false} importantForAccessibility="no">Notes only</Text>
          <Text style={styles.subText} accessible={false} importantForAccessibility="no">
        ...
        <Pressable
          ...
          hitSlop={10}
        >
          <Text style={[styles.btnText, notesOnly ? styles.btnTextOn : null]} accessible={false} importantForAccessibility="no">
            {notesOnly ? "On" : "Off"}
          </Text>
        </Pressable>
        ...
        <View
          style={styles.card}
          accessible={true}
          accessibilityLabel={`Playback instrument. Choose the instrument for playback audio. Current selection: ${INSTRUMENTS.find((i) => i.value === instrument)?.label || "Unknown"}.`}
        >
          <Text style={styles.cardTitle} accessible={false} importantForAccessibility="no">Playback instrument</Text>
          <Text style={styles.subText} accessible={false} importantForAccessibility="no">
            Choose the instrument for playback audio. Current selection:{" "}
            {INSTRUMENTS.find((i) => i.value === instrument)?.label || "Unknown"}.
          </Text>
        </View>
        <View style={styles.rowWrap} accessible={false}>
          {INSTRUMENTS.map((opt) => {
            ...
            return (
              <Pressable
                ...
                hitSlop={10}
              >
                <Text style={[styles.pillText, selected ? styles.pillTextOn : null]} accessible={false} importantForAccessibility="no">
                  {opt.label}
                </Text>
              </Pressable>
            );
        ...
        {!!err ? (
          ...
          >
            <Text style={styles.error} accessible={false} importantForAccessibility="no">{err}</Text>
          </View>
        ) : null}
        ...
        <Pressable
          ...
          hitSlop={10}
        >
          <Text style={styles.primaryText} accessible={false} importantForAccessibility="no">
